...
from beancount_plugin_utils.parse_config_string import parse_config_string, PluginConfigError
from beancount_plugin_utils.common import (
...
def share(
    ...
    try:
        ...
        return entries, [PluginConfigError(
    ...
    # Wrap each transform separately in a try-except, and return PluginConfigError with a nice error message.
    try:
    ...
    # 4. Create config itself. Just copy this block. Done!
