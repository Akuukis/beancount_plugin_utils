...
from beancount_plugin_utils.BeancountError import BeancountError, BeancountErrorNamedTuple
...
def on_marked_transactions(
    ...
    new_entries: Entries = []
    errors: List[BeancountErrorNamedTuple] = []
    ...
    for entry in entries:
        try:
            ...
            new_entries.append(entry)
            errors.append(BeancountError(entry.meta, str(e), entry).to_named_tuple())
