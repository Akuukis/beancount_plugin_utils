...
[![PyPI - Version](https://img.shields.io/pypi/v/beancount_plugin_utils)](https://pypi.org/project/beancount-share/)
[![PyPI - Downloads](https://img.shields.io/pypi/dm/beancount_plugin_utils)](https://pypi.org/project/beancount-share/)
[![PyPI - Wheel](https://img.shields.io/pypi/wheel/beancount_plugin_utils)](https://pypi.org/project/beancount-share/)
...
```
pip3 install beancount_plugin_utils --user
```

Or copy to path used for python. For example, `$HOME/.local/lib/python3.7/site-packages/beancount_plugin_utils/*` would do on Debian. If in doubt, look where `beancount` folder is and copy next to it.
